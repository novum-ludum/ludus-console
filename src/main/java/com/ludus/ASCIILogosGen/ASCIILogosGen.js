...
//*                                                                                                         *
//*                 WORKING: It exports the logos in a java enum, located in ../ASCIILogos.java ,           *
...
//*                                                                                                         *
//*                 Thanks :  Patrick Gillespie and other contributors :D                                   *
//*                                                                                                         *
...
//*     This file is AUTOMATICALLY GENERATED by ASCIILogosGen/ASCIILogosGen.js              *
...
var enumEnd = `;
    ...
    public static String getRand(){
        return  com.ludus.ASCIILogos.values()[new Random().nextInt(com.ludus.ASCIILogos.values().length)].getVal();
    }
}
`;
   		...
   		font.forEach(
   			function(f){
   				figlet.text('Ludus', {
				    ...
				    var varName = f.toString().toUpperCase().replace(/ /g,"_").replace(/3/g,"THREE").replace(/4/g,"FOUR").replace(/2/g,"TWO").replace(/1/g,"ONE").replace(/6/g,"SIX").replace(/5/g,"FIVE")/* some fonts start with numbers :( */ .replace(/-/g,"_").replace(/\'/g,""); //some have - :( the /g is regex for replace all occurences, apparently js has native regex syntax?
...
timer(3000).then(_=>console.log(enumEnd));
